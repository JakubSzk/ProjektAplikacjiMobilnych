...
@Composable
fun AddExerciseBackScreen(navController: NavHostController, bottomPadding: Dp){
            ...
            Column(
...

                {
                    ...
                    drawPath(//gorne_plecy
                        path = path4,
                        color = if ("gorne_plecy" in items) Color.Green else Color.Black
                    )
                    drawPath(//barki
                        path = path5,
                    ...
                    drawPath(//plecy
                        path = path7,
                        color = if ("plecy" in items) Color.Green else Color.Black
                    )
                    drawPath(//plecy_srodek_wieksze
                        path = path8,
                        color = if ("plecy_srodek_wieksze" in items) Color.Green else Color.Black
                    )
                    drawPath(//plecy_srodek_wieksze
                        path = path9,
                        color = if ("plecy_srodek_wieksze" in items) Color.Green else Color.Black
                    ...
                    drawPath(//posladki
                        path = path10,
                        color = if ("posladki" in items) Color.Green else Color.Black
                    )
                    drawPath(//posladki_gorne
                        path = path11,
                        color = if ("posladki_gorne" in items) Color.Green else Color.Black
                    )
                    drawPath(//plecy_dol
                        path = path12,
                        color = if ("plecy_dol" in items) Color.Green else Color.Black
                    )
                    drawPath(//uda_duze
                        path = path13,
                        color = if ("uda_duze" in items) Color.Green else Color.Black
                    )
                    drawPath(//uda_srednie
                        path = path14,
                        color = if ("uda_srednie" in items) Color.Green else Color.Black
                    )
                    drawPath(//uda_male
                        path = path15,
                        color = if ("uda_male" in items) Color.Green else Color.Black
                    )
                    drawPath(//lydki2
                        path = path16,
                        color = if ("lydki2" in items) Color.Green else Color.Black
                    )
                    drawPath(//lydki1
                        path = path17,
                        color = if ("lydki1" in items) Color.Green else Color.Black
                    )
                    drawPath(//tric2
                        path = path18,
                        color = if ("tric2" in items) Color.Green else Color.Black
                    )
                    drawPath(//tric1
                        path = path19,
                        color = if ("tric1" in items) Color.Green else Color.Black
                    )
                    drawPath(//tric3
                        path = path20,
                        color = if ("tric3" in items) Color.Green else Color.Black
                    )
                    drawPath(//przedramie2
                        path = path21,
                        color = if ("przedramie2" in items) Color.Green else Color.Black
                    )
                    drawPath(//przedramie1
                        path = path22,
                        color = if ("przedramie1" in items) Color.Green else Color.Black
                    )
                    drawPath(//dlon
                        path = path23,
